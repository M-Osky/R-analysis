...
option_list <- list(
  ...
  make_option(c("-b", "--bootspval"), type="integer",      default=1000, help="bootstrap iterations to generate p-values for Fsts and MCMC for HWE test [default: %default]"),
  make_option(c("-r", "--bootsci"), type="integer",      default=99,     help="bootstrap replicates to generate confidence intervals for Fis and Ar [default: %default]"),
...
cat("\nOpening ", genepopfile, " and calculating allelic diversity indexes, this will take long... ", sep="")
